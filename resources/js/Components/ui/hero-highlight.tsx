...
export const HeroHighlight = ({
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-dot-thick-neutral-300 dark:bg-dot-thick-green-300  pointer-events-none" />
      <motion.div
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block pb-1   px-1 rounded-lg bg-gradient-to-r from-welcomePrimary/60 to-welcomeBackground `,
        className
      )}
    >
      {children}
