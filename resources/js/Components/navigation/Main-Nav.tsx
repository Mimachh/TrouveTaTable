                    ...
                    <div className="flex">
                        ...
                        <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            ...
                            {user.isFondator || isAdmin ? (
                                ...
                                <p className="relative inline-flex items-center px-1 pt-1 text-sm text-muted-foreground/50 font-medium leading-5">
                                    Facture 🔏
                                </p>
                            )}
                        </div>
            ...
            >
                ...
                <div className="pt-4 pb-1 border-t border-gray-200">
                    ...
                    <div className="mt-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route("entreprise.edit")}>
                            Entreprise
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                            method="post"
