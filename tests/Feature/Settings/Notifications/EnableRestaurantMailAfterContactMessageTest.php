...
it('can enable restaurant mail if auth and restaurant is his', function () {
    ...
    $response = $this->actingAs($user)->put(route('dashboard.settings.notifications.notify-after-message-restaurant', ['restaurant' => $restaurant->id]), [
        'is_notify_restaurant_after_contact_message' => true,
    ]);
    assertDatabaseHas('restaurants', [
        'is_notify_restaurant_after_contact_message' => true,
